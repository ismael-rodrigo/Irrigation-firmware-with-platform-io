...
void DeviceManager::view(bool state_long_pressed_action_btn, bool action_button ,bool rigth_button ,bool left_button)
{
...
void DeviceManager::devices_view(){
  lcd.setCursor(0, 0);
...
void DeviceManager::config_device_view(bool active_button)
{ 
